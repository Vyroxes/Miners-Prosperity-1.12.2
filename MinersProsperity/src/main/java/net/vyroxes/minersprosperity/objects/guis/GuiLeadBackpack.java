...
import net.vyroxes.minersprosperity.objects.containers.ContainerLeadBackpack;

public class GuiLeadBackpack extends GuiContainer
{
    private static final ResourceLocation LEAD_BACKPACK_TEXTURE = new ResourceLocation(Tags.MODID, "textures/gui/lead_backpack.png");
    private final int backpackRows;

    public GuiLeadBackpack(ContainerLeadBackpack container)
    {
        super(container);
    ...
    {   	 
        ...
        this.mc.getTextureManager().bindTexture(LEAD_BACKPACK_TEXTURE);
