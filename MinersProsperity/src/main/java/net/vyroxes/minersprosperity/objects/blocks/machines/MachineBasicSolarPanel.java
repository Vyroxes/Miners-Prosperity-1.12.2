...
public class MachineBasicSolarPanel extends Machine {
    public MachineBasicSolarPanel(String name) {
    ...
    public @NotNull Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(BlockInit.BASIC_SOLAR_PANEL);
    }

    @Override
    public TileEntityMachine getTileEntity(World world, BlockPos pos) {
        return (TileEntityBasicSolarPanel) world.getTileEntity(pos);
    }
