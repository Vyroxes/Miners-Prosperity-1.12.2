...
public class TileEntityImprovedSolarPanel extends TileEntityMachine
{
    public TileEntityImprovedSolarPanel()
    {
        super(new Builder()
                .setItemEnergy(1)
                .setEnergy(40000, 0, 400, 0)
    ...
    {
        return this.hasCustomName() ? new TextComponentString(this.customName) : new TextComponentTranslation("container.improved_solar_panel");
    }
