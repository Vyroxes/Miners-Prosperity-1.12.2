...
import net.vyroxes.minersprosperity.objects.tileentities.TileEntityAdvancedSolarPanel;
import net.vyroxes.minersprosperity.objects.tileentities.TileEntityEliteSolarPanel;
...
public class MachineEliteSolarPanel extends Machine {
    public MachineEliteSolarPanel(String name) {
    ...
    public @NotNull Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(BlockInit.ELITE_SOLAR_PANEL);
    }

    @Override
    public TileEntityMachine getTileEntity(World world, BlockPos pos) {
        return (TileEntityEliteSolarPanel) world.getTileEntity(pos);
    }

    @Override
    @NonnullByDefault
    public @Nullable TileEntity createNewTileEntity(World worldIn, int meta) {
        return new TileEntityEliteSolarPanel();
    }
