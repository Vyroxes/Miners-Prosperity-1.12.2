...
import net.vyroxes.minersprosperity.objects.containers.ContainerDiamondBackpack;

public class GuiDiamondBackpack extends GuiContainer
{
    private static final ResourceLocation DIAMOND_BACKPACK_TEXTURE = new ResourceLocation(Tags.MODID, "textures/gui/diamond_backpack.png");
    private final int backpackRows;

    public GuiDiamondBackpack(ContainerDiamondBackpack container)
    {
        super(container);
    ...
    {   	 
        ...
        this.mc.getTextureManager().bindTexture(DIAMOND_BACKPACK_TEXTURE);
