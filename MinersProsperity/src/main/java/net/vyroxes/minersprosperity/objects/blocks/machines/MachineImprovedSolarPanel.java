...
import net.vyroxes.minersprosperity.objects.tileentities.TileEntityBasicSolarPanel;
import net.vyroxes.minersprosperity.objects.tileentities.TileEntityImprovedSolarPanel;
...
public class MachineImprovedSolarPanel extends Machine {
    public MachineImprovedSolarPanel(String name) {
    ...
    public @NotNull Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(BlockInit.IMPROVED_SOLAR_PANEL);
    }

    @Override
    public TileEntityMachine getTileEntity(World world, BlockPos pos) {
        return (TileEntityImprovedSolarPanel) world.getTileEntity(pos);
    }

    @Override
    @NonnullByDefault
    public @Nullable TileEntity createNewTileEntity(World worldIn, int meta) {
        return new TileEntityImprovedSolarPanel();
    }
