...
import net.vyroxes.minersprosperity.objects.containers.ContainerGoldenBackpack;

public class GuiGoldenBackpack extends GuiContainer
{
    private static final ResourceLocation GOLDEN_BACKPACK_TEXTURE = new ResourceLocation(Tags.MODID, "textures/gui/golden_backpack.png");
    private final int backpackRows;

    public GuiGoldenBackpack(ContainerGoldenBackpack container)
    {
        super(container);
    ...
    {   	 
        ...
        this.mc.getTextureManager().bindTexture(GOLDEN_BACKPACK_TEXTURE);
