...
public class GuiBackButton extends GuiButton
{
	...
	public GuiBackButton(int buttonId, int x, int y, int width, int height, ResourceLocation texture, int textureX, int textureY, String tooltip)
    {
