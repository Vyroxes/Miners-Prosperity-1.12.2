...
public class MachineAdvancedSolarPanel extends Machine {
    public MachineAdvancedSolarPanel(String name) {
    ...
    public @NotNull Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(BlockInit.ADVANCED_SOLAR_PANEL);
    }

    @Override
    public TileEntityMachine getTileEntity(World world, BlockPos pos) {
        return (TileEntityAdvancedSolarPanel) world.getTileEntity(pos);
    }
