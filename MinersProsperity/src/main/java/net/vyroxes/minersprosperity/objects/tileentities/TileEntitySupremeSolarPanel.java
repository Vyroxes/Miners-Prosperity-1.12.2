...
public class TileEntitySupremeSolarPanel extends TileEntityMachine
{
    public TileEntitySupremeSolarPanel()
    {
        super(new Builder()
                .setItemEnergy(1)
                .setEnergy(640000, 0, 6400, 0)
    ...
    {
        return this.hasCustomName() ? new TextComponentString(this.customName) : new TextComponentTranslation("container.supreme_solar_panel");
    }
