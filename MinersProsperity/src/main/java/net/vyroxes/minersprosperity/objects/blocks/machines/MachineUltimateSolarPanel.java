...
public class MachineUltimateSolarPanel extends Machine {
    public MachineUltimateSolarPanel(String name) {
    ...
    public @NotNull Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(BlockInit.ULTIMATE_SOLAR_PANEL);
    }

    @Override
    public TileEntityMachine getTileEntity(World world, BlockPos pos) {
        return (TileEntityUltimateSolarPanel) world.getTileEntity(pos);
    }
