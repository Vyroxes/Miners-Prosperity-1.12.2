...
public class TileEntityBasicSolarPanel extends TileEntityMachine
{
    public TileEntityBasicSolarPanel()
    {
        super(new Builder()
                .setItemEnergy(1)
                .setEnergy(20000, 0, 200, 0)
    ...
    {
        return this.hasCustomName() ? new TextComponentString(this.customName) : new TextComponentTranslation("container.basic_solar_panel");
    }
