...
public class TileEntityEliteSolarPanel extends TileEntityMachine
{
    public TileEntityEliteSolarPanel()
    {
        super(new Builder()
                .setItemEnergy(1)
                .setEnergy(160000, 0, 1600, 0)
    ...
    {
        return this.hasCustomName() ? new TextComponentString(this.customName) : new TextComponentTranslation("container.elite_solar_panel");
    }
