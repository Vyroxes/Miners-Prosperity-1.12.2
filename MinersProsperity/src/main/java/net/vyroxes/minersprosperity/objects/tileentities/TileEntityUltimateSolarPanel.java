...
public class TileEntityUltimateSolarPanel extends TileEntityMachine
{
    public TileEntityUltimateSolarPanel()
    {
        super(new Builder()
                .setItemEnergy(1)
                .setEnergy(320000, 0, 3200, 0)
    ...
    {
        return this.hasCustomName() ? new TextComponentString(this.customName) : new TextComponentTranslation("container.ultimate_solar_panel");
    }
