...
public class ConfigHandler
{
	...
	public static int clusterCountLeadOre = 7;
	...
	public static int clusterCountSilverOre = 6;
    ...
    public static void init(File file)
    {
		...
		clusterCountLeadOre = config.getInt("Lead Ore Cluster Count", categoryOres, 7, 1, 100, "Set cluster count for generating Lead Ore");
		...
		clusterCountSilverOre = config.getInt("Silver Ore Cluster Count", categoryOres, 6, 1, 100, "Set cluster count for generating Silver Ore");
